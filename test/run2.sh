python test_zero_shot.py ../llama2-7b wikitext2 \
        --wbits 4 --abits 16 --a_sym --w_sym --save_model \
        ...
        --eval_common_sense --lm_eval_limit 2 \
        --save_dir ../saved \
        --save_model_name llama7b_wonly_quant_quantized.pth \
        --test_name llamma2-7b-wonly-quant \
        --hook_data